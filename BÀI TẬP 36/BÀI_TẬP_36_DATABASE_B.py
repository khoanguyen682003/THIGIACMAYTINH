...
class AttendanceDB:
    def __init__(self):
        self.conn = sqlite3.connect("C:/Users/Acer/Downloads/THIGIACMAYTINH_THAYTUNG-master/THIGIACMAYTINH_THAYTUNG-master/BÀI TẬP 36/my_database.db")
        self.create_tables()
    ...
    def mark_attendance(self, student_id, class_id, confidence):
        cursor = self.conn.cursor()
        today = datetime.now().strftime("XY-%m-%d")
        cursor.execute('''
...
a = AttendanceDB()
print(a.mark_attendance("123456","21DTH1",0.8))
